...
/* 	prompt user to enter father's age 
	collect father's  name from user assign it to a box fatherage
	prompt user to enter son's age
	collect son's  name from user  assign it to a box sonage
	calculate twice the son age by multiplying the age by 2 and assign the result to box twicesonage
